...
import LighthouseAuditButton from "@/app/admin/components/LighthouseAuditButton";
        ...
        <div className="bg-white border rounded-xl p-5 space-y-3">
          ...
          <div className="space-y-2">
            ...
            {relatedTemplates.length === 0 && (
              <p className="text-sm text-gray-400">No templates found. <Link href="/admin/templates" className="text-blue-600 hover:underline">Create one →</Link></p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        {scan && (
          <div className="flex items-center gap-2">
            ...
            <a href="/admin/lighthouse" className="text-xs text-indigo-500 hover:underline">Run new scan →</a>
          </div>
        )}
      </div>
      ...
      {website && scan === null && (
        <div className="flex items-center gap-3 text-sm text-gray-500 bg-yellow-50 border border-yellow-100 rounded-lg px-4 py-3">
          ...
          <span>
            ...
            <a href="/admin/lighthouse" className="text-blue-600 hover:underline font-medium">Run a Lighthouse scan →</a>
          </span>
        </div>
      )}
